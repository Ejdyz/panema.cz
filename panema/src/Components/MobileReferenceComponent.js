...
export default function MobileReferenceComponent(props) {
  ...
  return (
    <>
      <Container style={{ width: "100%", backgroundColor: "#212529", textAlign: "center", color: "white", display: "flex", alignItems: "center", justifyContent: 'space-evenly', padding: "20px", borderRadius: "20px", minHeight: "150px" }}>
        ...
        <div style={{ width: "50%" }}>
          <img src={props.logo} alt={props.name} style={{ maxWidth: "150px", maxHeight: "80px", borderRadius: "10px", padding: "5px" }} />
        </div>
      </Container>
